...
# An investigation into the variables that impact mental health
...
ggsave(sub_depression_graph, filename = "Figure_1.png")
```
...
```{r}
F2 <- ggplot(data = CESD.aov, aes(x = Substance, y = CESD)) +
...
ggsave(F2, filename = "Figure_2.png")
```
...
ggsave(mental_score_graph, filename = "Figure_3.png")
```
...
ggsave(gender_graph, filename = "Figure_4.png")
```
...
ggsave(correlation, filename = "Figure_5.png")
```
